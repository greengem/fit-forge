...
import { IconJumpRope, IconList, IconStretching, IconUser } from '@tabler/icons-react';
...
export default function DashboardLinks() {
    ...
    return (
        <div className="flex flex-wrap gap-x-3 gap-y-2">
            {links.map(link => (
                <Button color="success" variant="ghost" key={link.href} as={Link} href={link.href} className="gap-unit-1">
