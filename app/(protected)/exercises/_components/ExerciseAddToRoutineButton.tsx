...
export default function ExerciseAddToRoutineButton({ exercise, userRoutines }: ExerciseAddToRoutineButtonProps) {
    const { setExercise, setUserRoutines, onOpen } = useContext(ExerciseAddToRoutineModalContext);
    ...
    const handleClick = () => {
      ...
      return <Button isIconOnly onClick={handleClick}><IconPlus size={20} /></Button>;
}
