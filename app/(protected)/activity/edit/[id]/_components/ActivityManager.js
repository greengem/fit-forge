    ...
    return (
        <>
            <div className='grid grid-cols-1 md:grid-cols-2 gap-x-5 gap-y-3'>
                <Input type='text' className='mb-3' name='duration' label='Total Workout Duration' value={activity.duration} />
                <Input type='text' className='mb-3' name='duration' label='Date and Time' value={activity.date} />
            </div>
