...
export default async function DashboardChartProgressOverTime({ dateRange = '3M' }: { dateRange?: string }) {
  ...
  const adjustedData = intervals.map(interval => {
    ...
    let lastCumulativeWeight = cumulativeWeightsUpToInterval.length > 0
