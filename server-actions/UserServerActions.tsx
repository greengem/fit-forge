...
export async function handleUpdateUserInfo(data: { age: string, height: string, weight: string }) {
...
export async function handleUpdateUserEquipment(selectedEquipment: EquipmentType[]) {
    const { userId }: { userId: string | null } = auth();
